...
#SBATCH --mem=48G
#SBATCH --job-name='train_4_run'
#SBATCH --account=pi_ozguryilmaze_umass_edu
#SBATCH --chdir=/scratch/workspace/anshitagupta_umass_edu-ai-gold-confinement/aravadikeshr_tests/au_workflow/pzc/Training/MLFF4
...
python -m mace.cli.preprocess_data \
    --train_file="train_model_4.xyz" \
    --valid_file="val_model_4.xyz"\
	--energy_key='energy'\
	--forces_key='forces'\
