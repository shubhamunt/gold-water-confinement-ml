...
#SBATCH --mem=48G
#SBATCH --job-name='train_2_run'
#SBATCH --account=pi_ozguryilmaze_umass_edu
#SBATCH --chdir=/scratch/workspace/anshitagupta_umass_edu-ai-gold-confinement/aravadikeshr_tests/au_workflow/pzc/Training/MLFF2
